    ...
    return (
        <>
            <TitledPage title="New Template">
                ...
                />
                <Pressable onPress={() => {modalizeRef.current?.open()}} style={styles.addExerciseButton}>
                    <ThemedText type="smallSubtitle">Add exercise</ThemedText>
                </Pressable>
            </TitledPage>


            <SelectExerciseModal modalizeRef={modalizeRef} exercises={exercises} onAddExercisesPress={onAddExercisesPress} />
        </>
    )
}
